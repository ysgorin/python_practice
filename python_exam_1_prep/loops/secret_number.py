...
# He wants everyone who run his program to play
# the Guess the secret number game,
# and guess what number he has picked for them.
# Those who don't guess the number will be stuck
# in an endless loop forever!

# Your task is to help the magician complete the code
# in the editor in such a way so that the code:

# will ask the user to enter an integer number;

# will use a while loop;

# will check whether the number entered by the user
# is the same as the number picked by the magician.
# If the number chosen by the user is different than
# the magician's secret number, the user should
# see the message "Ha ha! You're stuck in my loop!"
...
while guess != 777:
    ...
    guess = int(input('Try again. What is the secret number? '))

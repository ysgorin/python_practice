...
# Complicated? Not at all. For example, 8 isn't a
# prime number, as you can divide it by 2 and 4
# (we can't use divisors equal to 1 and 8, as the
# definition prohibits this).

# On the other hand, 7 is a prime number, as we
# can't find any legal divisors for it.
